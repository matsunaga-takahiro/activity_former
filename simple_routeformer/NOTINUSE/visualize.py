...
adj_matrix = torch.load("data_generation/grid_adjacency_matrix.pt")
node_features = torch.load("data_generation/node_features_matrix.pt")
route_df = pd.read_csv("route_test.csv", index_col=0)
...
o = 0
d = 15
paths = route_df.loc[:, "1":"15"].values.tolist()
